...
- 커뮤니티 공략 임시 저장, JSON 가져오기/내보내기, GitHub 이슈 제보 링크
- 에이전트 40명, W-Engine 93종, 활성 디스크 21종, 재화 카테고리 데이터 표
- 정적 GitHub Pages 배포
...
GitHub Pages만으로는 공개 업로드를 직접 받을 수 없습니다. 커뮤니티 탭은 공략을 사용자 브라우저에 저장하고, JSON 공유와 GitHub 이슈 제보 링크를 지원합니다.
